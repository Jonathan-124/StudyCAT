"""
Django settings for studycat project.
...
SECRET_KEY = 'b5!t*c6umi77erbxl@v@tafkip14sm108#=m55os()si%b%965'
...
WSGI_APPLICATION = 'studycat.wsgi.application'
